...
//                
                ...
                if (result.getStatus() == Status.VALID) {
                    ...
                    KeepRecord.setUser_id(asbl.getUserIdfromUsername(username));
                    ...
                    if (result.getCallerGroups().contains("Admin")) {
                        request.getRequestDispatcher("admin/index.jsf?faces-redirect=True").forward(request, response);
                    }
                    if (result.getCallerGroups().contains("User")) {
                        request.getRequestDispatcher("user/index.jsf?faces-redirect=True").forward(request, response);
                    }
                    ...
                    response.sendRedirect("Login.jsf?faces-redirect=True");
